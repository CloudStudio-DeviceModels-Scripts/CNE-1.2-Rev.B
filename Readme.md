...
# Configuration Script – CNE-1.2 - Rev. B

This **Configuration** script is designed for the **CNE-1.2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – CNE-1.2 Rev. B

Este script de **Configuration** está diseñado para el modelo **CNE-1.2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
